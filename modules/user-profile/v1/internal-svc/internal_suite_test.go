...
import (
	...
	"github.com/deqode/GoArcc/modules/user-profile/v1/internal-svc"
...
var (
	UserProfileServerIntTest pb.UserProfileInternalServer
	CtxTest                  context.Context
	UsrProfile               *pb.UserProfile
)

func TestUserProfileInternalSvc(t *testing.T) {
	//now init logger
	...
	RunSpecs(t, "TestUserProfile Internal Service Suite")
}
