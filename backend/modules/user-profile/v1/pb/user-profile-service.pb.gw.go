...
// RegisterUserProfileServiceHandlerServer registers the http handlers for service user-profile to "mux".
...
func RegisterUserProfileServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UserProfileServiceServer) error {
	...
	mux.Handle("GET", pattern_UserProfileService_GetUserProfile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/alfred.user_profile.v1.user-profile/GetUserProfile")
		if err != nil {
...
// RegisterUserProfileServiceHandler registers the http handlers for service user-profile to "mux".
...
// RegisterUserProfileServiceHandlerClient registers the http handlers for service user-profile
...
func RegisterUserProfileServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UserProfileServiceClient) error {
	...
	mux.Handle("GET", pattern_UserProfileService_GetUserProfile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/alfred.user_profile.v1.user-profile/GetUserProfile")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
