...
func RegisterUserProfileInternalServer(s grpc.ServiceRegistrar, srv UserProfileInternalServer) {
	s.RegisterService(&UserProfileInternal_ServiceDesc, srv)
}
...
// UserProfileInternal_ServiceDesc is the grpc.ServiceDesc for UserProfileInternal service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var UserProfileInternal_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pb/user_profile_internal.proto",
}
