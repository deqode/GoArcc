...
// ArchitectureSuggesterServiceClient is the client API for ArchitectureSuggesterService service.
//
...
func (c *architectureSuggesterServiceClient) GetArchitecture(ctx context.Context, in *GetArchitectureRequest, opts ...grpc.CallOption) (*GetArchitectureResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.ArchitectureSuggesterService/GetArchitecture", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// ArchitectureSuggesterServiceServer is the server API for ArchitectureSuggesterService service.
...
func _ArchitectureSuggesterService_GetArchitecture_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.ArchitectureSuggesterService/GetArchitecture",
	}
...
// ArchitectureSuggesterService_ServiceDesc is the grpc.ServiceDesc for ArchitectureSuggesterService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var ArchitectureSuggesterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pb.ArchitectureSuggesterService",
