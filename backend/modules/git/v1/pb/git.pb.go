...
var file_git_proto_depIdxs = []int32{
	...
	8,  // 4: alfred.git.v1.ListRepositoryRequest.provider:type_name -> alfred.types.VCSProviders
	2,  // 5: alfred.git.v1.ListRepositoryResponse.repositories:type_name -> alfred.git.v1.Repository
	8,  // 6: alfred.git.v1.GetRepositoryRequest.provider:type_name -> alfred.types.VCSProviders
